    ...
    const fetchData = async () => {
      try {
        ...
        const formattedData = response.data.map((item) => {
          ...
          return {
            date: item.Date,
            callChange: item.DII_Call_OI,
            putChange: item.DII_Put_OI,
    ...
    <div className="w-full max-w-6xl mx-auto p-4">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-indigo-700 to-blue-600 p-6 text-white">
          <h1 className="text-2xl font-bold mb-2">DII Open Interest in Index Options</h1>
          <p className="text-blue-100">
            Domestic Institutional Investors' Call vs Put Open Interest vs NIFTY 50
          </p>
        </div>
        ...
        <div className="bg-gray-50 px-6 py-3 text-center text-sm text-gray-500 border-t border-gray-200">
          <p>
            ...
            <span className="text-blue-500 mx-2">Blue: Put OI</span> | 
            <span className="text-red-500">Red: Negative OI</span>
          </p>
        </div>
      </div>
    </div>
