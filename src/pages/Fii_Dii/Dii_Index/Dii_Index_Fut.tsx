...
const Dii_Index_Fut: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setIsLoading(true);
        const response = await axios.get<FIIData[]>("https://api.upholictech.com/api/DII_Index_Fut/data");
  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[500px] space-y-4">
        ...
        <p className="text-gray-600">Loading DII Futures data...</p>
      </div>
    );
  }
    ...
    <div className="w-full max-w-6xl mx-auto p-4">
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-indigo-700 to-blue-600 p-6 text-white">
          <h1 className="text-2xl font-bold mb-1">DII Index Futures Activity</h1>
          <p className="text-blue-100">
            Domestic Institutional Investors' positions in Index Futures vs NIFTY 50 performance
          </p>
        </div>
