...
const Fii_Index_Fut: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setIsLoading(true);
        const response = await axios.get<FIIData[]>("https://api.upholictech.com/api/FII_Index_Fut/data");
        // const response = await axios.get<FIIData[]>("https://api.upholictech2.com/api/FII_Index_Fut/data");
