        ...
        >
          ...
          <div className="relative z-10 p-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to='/signup' className="group relative px-8 py-4 text-white font-bold rounded-xl overflow-hidden transition-all duration-300 bg-gradient-to-r from-[#2a36a8] to-[#5a66e0] hover:from-[#25309a] hover:to-[#505cdc]">
