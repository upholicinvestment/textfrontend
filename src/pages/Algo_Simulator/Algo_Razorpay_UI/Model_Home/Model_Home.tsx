...
//   details: (renderKey: number) => React.ReactNode;
//   buttonText: string;
//   actionText: string;
//   color: string;
//   route: string;
...
//   const [renderKey, setRenderKey] = useState(0); // for triggering re-render on hover

//   const animatedList = (points: string[], renderKey: number) => (
//     <ul key={renderKey} className="space-y-3 pl-5 list-disc">
//       {points.map((text, index) => (
//         <li
//           key={index}
//           className="text-white/80 opacity-0 animate-fade-in-right"
//           style={{
...
//         animatedList(
//           [
//             "Experience 24x7 algorithmic trading without emotional interference",
//             "Seamless integration with top brokers for effortless strategy deployment",
//             "Monitor real-time performance with live risk-to-reward ratios (2:1)",
//             "Maintains a strike rate of over 50% across tested strategies",
//             "Complete transparency with broker connection status and execution logs",
//             "Trusted by professionals with proven results",
//           ],
//           key
//         ),
...
//           {(["swing", "starter"] as ModelKey[]).map((key) => (
//             <Link
//               key={key}
//               to={models[key].route}
//               className="block w-56"
//               onMouseEnter={() => handleModelHover(key)}
//               onMouseLeave={() => setShowInfoPanel(false)}
//             >
//               <div
//                 className={`model-card bg-gradient-to-br ${
...
//                     {currentModel.details(renderKey)}
//                   </p>
//                 </div>
//               </div>
//             </div>
